...
export function PercentilePredictorPage() {
  ...
  return (
    <div className="max-w-xl mx-auto">
      <h1 className="text-2xl font-semibold text-gray-900 mb-2">Percentile Predictor</h1>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-5 mb-4">
        <label className="block text-sm mb-4">
          <span className="block text-gray-600 mb-1">Your raw score</span>
          <input
            type="number"
            value={score}
        ...
        {percentile !== null && (
          <div className="text-center py-4 border-t border-gray-100">
            <p className="text-sm text-gray-500 mb-1">Estimated percentile</p>
            <p className="text-4xl font-bold text-indigo-600">{percentile}<span className="text-lg text-gray-400">th</span></p>
          </div>
        )}
      </div>
