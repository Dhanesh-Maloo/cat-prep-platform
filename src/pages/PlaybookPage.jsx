...
export function PlaybookPage() {
  return (
    <div className="max-w-3xl mx-auto space-y-10">
      <div>
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-2">99th Percentile Playbook</h1>
      ...
      <section>
        <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">What 99th percentile actually requires</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {SECTIONAL_TARGETS.map((t) => (
            <TiltCard key={t.section} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
              <h3 className="font-medium text-gray-800 dark:text-gray-200 mb-1">{t.section}</h3>
              <p className="text-2xl font-semibold text-indigo-600 dark:text-indigo-400 mb-1">{t.range}</p>
      ...
      <section>
        <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">DILR: pick 2-3 sets, not all 4</h2>
      ...
      <section>
        <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Section-by-section time allocation</h2>
        <div className="space-y-3">
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <h3 className="font-medium text-gray-800 dark:text-gray-200 mb-1">VARC (40 minutes, ~24 questions)</h3>
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <h3 className="font-medium text-gray-800 dark:text-gray-200 mb-1">DILR (40 minutes, ~20 questions)</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <h3 className="font-medium text-gray-800 dark:text-gray-200 mb-1">QA (40 minutes, ~22 questions)</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
      ...
      <section>
        <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Accuracy over attempts</h2>
      ...
      <section className="bg-indigo-50 dark:bg-indigo-950 border border-indigo-100 dark:border-indigo-800 rounded-lg p-5">
        <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2">The habit that compounds: an error log</h2>
        <p className="text-gray-700 dark:text-gray-300 text-sm mb-3">
          ...
          This platform's <Link to="/mistakes" className="text-indigo-600 dark:text-indigo-400 hover:underline font-medium">Mistake Notebook</Link> automatically
      ...
      <section>
        <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2">Quick reference</h2>
        <p className="text-gray-700 dark:text-gray-300 text-sm">
          For formulas and shortcuts you should be able to recall instantly under exam pressure, see the{' '}
          <Link to="/formula-sheet" className="text-indigo-600 dark:text-indigo-400 hover:underline">Formula &amp; Shortcuts Cheat Sheet</Link>.
        </p>
      </section>
    </div>
  )
